...
//
// These tests verify Xcode integration with Plasma daemon using Unix sockets.
...
fn test_xcode_with_unix_socket() {
    ...
    let output = Command::new("xcodebuild")
        .arg("-project")
        .arg(fixture_path.join("Plasma.xcodeproj"))
        .arg("-scheme")
        .arg("Plasma")
        .arg("-destination")
    ...
    // Clean derived data (but keep Plasma cache)
