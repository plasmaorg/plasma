...
//
// These tests verify TurboRepo integration with Plasma daemon.
...
//
// However, Plasma uses a simpler compatible API:
...
fn test_turborepo_cache_with_daemon() {
    ...
    // Set environment variables for TurboRepo to use Plasma
