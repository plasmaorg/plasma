...
- Add plasma init command and rename config to plasma.toml ([6e8648a](6e8648a68f794aca7e41e02717a1b47eda549489))
- Add test isolation with PLASMA_STATE_DIR and fix daemon port binding ([4e4c657](4e4c657a029e6231068e9ad8ea3e7dbdd6d299b0))
...
- Add cache activity logging to PlasmaStore ([7afa86d](7afa86defef98ec3fcb18ac193dfda6ad3ab61df))

### 🚜 Refactor

- Rename package to @plasmaorg/plasma and update references ([883f456](883f4568e82e7116d3e82ae8bab55d36ebd8967f))
- Restructure package as @plasmaorg/plasma with /metro subpath ([3575c47](3575c473229394e42f7e3c49a13b3cffa142817a))
...
- Add @plasma/metro NPM package for Metro bundler integration ([752b03b](752b03b1d342b0967e9d77d19b2cd6d67e16c4e0))
- Add development mode to @plasma/metro using cargo run ([0adc976](0adc97610d718ac088ad931fa03ac644c2b8e60a))

### 🚜 Refactor

- Convert @plasma/metro to vanilla JS with dependency injection ([bc8160f](bc8160fc8ebe646b0b559d3d310f3f5090eb05e4))
...
- Implement plasma exec with Unix socket support for Xcode ([6c8ce0b](6c8ce0b650ea497a306c4a7855bf739f36a73aad))
- Implement plasma xcodebuild command with 100% cache hit rate! ([6fefe2f](6fefe2f9e1e2076e80e4041404254bde0eaa8540))
