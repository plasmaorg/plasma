//! Plasma Cache gRPC service implementation
//!
//! This service implements the PlasmaCache protocol for Layer 2 servers.
//! It handles Exists, Get, Put, Delete, and GetStats operations.

use crate::plasma_protocol::proto::plasma_cache_server::PlasmaCache;
use crate::plasma_protocol::proto::{
...
/// Plasma Cache gRPC service
pub struct PlasmaCacheService {
    storage: Arc<FilesystemStorage>,
}

impl PlasmaCacheService {
    /// Create a new Plasma cache service
...
#[tonic::async_trait]
impl PlasmaCache for PlasmaCacheService {
...
mod tests {
    ...
    async fn test_exists_not_found() {
        ...
        let service = PlasmaCacheService::new(storage);
    ...
    async fn test_put_and_exists() {
        let (_temp, storage) = create_test_storage();
        let service = PlasmaCacheService::new(storage.clone());
