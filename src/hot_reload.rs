//! Hot-reload support for Plasma configuration
//!
...
pub struct HotReloadableConfig {
    ...
    config: RwLock<Arc<PlasmaConfig>>,
...
impl HotReloadableConfig {
    ...
    pub fn new(config: PlasmaConfig, config_path: PathBuf) -> Self {
    ...
    pub async fn get(&self) -> Arc<PlasmaConfig> {
    ...
    pub async fn reload(&self) -> Result<()> {
        ...
        match PlasmaConfig::from_file(&self.config_path) {
            Ok(new_config) => {
    ...
    fn log_config_changes(old: &PlasmaConfig, new: &PlasmaConfig) {
...
impl HotReloadManager {
    ...
    pub async fn new(config: PlasmaConfig, config_path: impl AsRef<Path>) -> Result<Self> {
...
mod tests {
    ...
    fn create_test_config(dir: &Path) -> PathBuf {
        let config_path = dir.join("plasma.toml");
...
"#;
    ...
    async fn test_hot_reloadable_config() {
        ...
        let config = PlasmaConfig::from_file(&config_path).unwrap();
