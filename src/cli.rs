...
///
/// Plasma provides transparent, high-performance caching for build systems
/// like Gradle, Bazel, Nx, and TurboRepo.
#[derive(Parser, Debug)]
#[command(name = "plasma")]
#[command(author = "Plasma Team")]
...
pub struct CommonConfigArgs {
    /// Config file path
    #[arg(short = 'c', long, env = "PLASMA_CONFIG")]
    pub config: Option<String>,

    /// Local cache directory
    #[arg(long, env = "PLASMA_CONFIG_CACHE_DIR")]
    pub config_cache_dir: Option<String>,

    /// Max local cache size (e.g., "5GB", "500MB")
    #[arg(long, env = "PLASMA_CONFIG_MAX_CACHE_SIZE")]
    pub config_max_cache_size: Option<String>,

    /// Upstream cache URL(s), comma-separated
    #[arg(long, env = "PLASMA_CONFIG_UPSTREAM", value_delimiter = ',')]
    pub config_upstream: Option<Vec<String>>,

    /// Log level (trace|debug|info|warn|error)
    #[arg(long, env = "PLASMA_CONFIG_LOG_LEVEL")]
...
pub enum Commands {
    ...
    /// Deactivate Plasma and clean up environment
...
pub struct ExecArgs {
    ...
    #[arg(long, env = "PLASMA_CONFIG_METRICS_PORT")]
    ...
    #[arg(long, default_value = "PLASMA_")]
...
pub struct ServerArgs {
    ...
    #[arg(long, env = "PLASMA_CONFIG_S3_REGION")]
    pub config_s3_region: Option<String>,

    #[arg(long, env = "PLASMA_CONFIG_S3_ENDPOINT")]
    pub config_s3_endpoint: Option<String>,

    #[arg(long, env = "PLASMA_CONFIG_S3_ACCESS_KEY")]
    pub config_s3_access_key: Option<String>,

    #[arg(long, env = "PLASMA_CONFIG_S3_SECRET_KEY")]
    pub config_s3_secret_key: Option<String>,

    // NETWORK BINDINGS
    #[arg(long, env = "PLASMA_CONFIG_HTTP_BIND", default_value = "0.0.0.0:8080")]
    pub config_http_bind: String,

    #[arg(long, env = "PLASMA_CONFIG_GRPC_BIND", default_value = "0.0.0.0:9090")]
    pub config_grpc_bind: String,

    #[arg(long, env = "PLASMA_CONFIG_S3_BIND", default_value = "0.0.0.0:9000")]
    pub config_s3_bind: String,

    /// Plasma protocol server bind address (gRPC)
    #[arg(
        long,
        env = "PLASMA_CONFIG_PLASMA_BIND",
        default_value = "0.0.0.0:7070"
    )]
    pub config_plasma_bind: String,

    // AUTHENTICATION
    #[arg(long, env = "PLASMA_CONFIG_JWT_PUBLIC_KEY_FILE")]
    pub config_jwt_public_key_file: Option<String>,

    #[arg(long, env = "PLASMA_CONFIG_JWT_PUBLIC_KEY")]
    pub config_jwt_public_key: Option<String>,

    #[arg(long, env = "PLASMA_CONFIG_JWT_JWKS_URL")]
    pub config_jwt_jwks_url: Option<String>,

    #[arg(long, env = "PLASMA_CONFIG_JWT_KEY_REFRESH")]
    pub config_jwt_key_refresh: Option<String>,

    #[arg(long, env = "PLASMA_CONFIG_JWT_REQUIRED")]
    pub config_jwt_required: Option<bool>,

    // CACHE BEHAVIOR
    #[arg(long, env = "PLASMA_CONFIG_EVICTION_POLICY")]
    pub config_eviction_policy: Option<String>,

    #[arg(long, env = "PLASMA_CONFIG_DEFAULT_TTL")]
    pub config_default_ttl: Option<String>,

    #[arg(long, env = "PLASMA_CONFIG_WRITE_THROUGH")]
    pub config_write_through: bool,

    #[arg(long, env = "PLASMA_CONFIG_UPSTREAM_WORKERS")]
    ...
    #[arg(long, env = "PLASMA_CONFIG_LOG_FORMAT")]
    pub config_log_format: Option<String>,

    #[arg(long, env = "PLASMA_CONFIG_HEALTH_BIND")]
    pub config_health_bind: Option<String>,

    #[arg(long, env = "PLASMA_CONFIG_HEALTH_ENABLED")]
    pub config_health_enabled: Option<bool>,

    #[arg(long, env = "PLASMA_CONFIG_API_BIND")]
    pub config_api_bind: Option<String>,

    #[arg(long, env = "PLASMA_CONFIG_METRICS_ENABLED")]
    pub config_metrics_enabled: Option<bool>,

    #[arg(long, env = "PLASMA_CONFIG_CACHE_QUERY_API_ENABLED")]
    pub config_cache_query_api_enabled: Option<bool>,

    #[arg(long, env = "PLASMA_CONFIG_ADMIN_API_ENABLED")]
    pub config_admin_api_enabled: Option<bool>,

    #[arg(long, env = "PLASMA_CONFIG_API_AUTH_REQUIRED")]
    pub config_api_auth_required: Option<bool>,

    #[arg(long, env = "PLASMA_CONFIG_API_JWT_PUBLIC_KEY_FILE")]
    pub config_api_jwt_public_key_file: Option<String>,

    #[arg(long, env = "PLASMA_CONFIG_TRACING_ENABLED")]
    pub config_tracing_enabled: Option<bool>,

    #[arg(long, env = "PLASMA_CONFIG_TRACING_ENDPOINT")]
    pub config_tracing_endpoint: Option<String>,

    // HIGH AVAILABILITY
    #[arg(long, env = "PLASMA_CONFIG_GRACEFUL_SHUTDOWN")]
...
pub struct HealthArgs {
    /// URL of Plasma instance to check
    #[arg(long, env = "PLASMA_HEALTH_URL")]
    pub url: Option<String>,

    /// Request timeout
    #[arg(long, default_value = "5s", env = "PLASMA_HEALTH_TIMEOUT")]
    pub timeout: String,

    /// Output format (text, json)
    #[arg(long, default_value = "text", env = "PLASMA_HEALTH_FORMAT")]
    pub format: String,
}
...
pub struct DoctorArgs {
    ...
    /// Verbose output
    #[arg(short, long, env = "PLASMA_VERBOSE")]
    pub verbose: bool,
}
...
pub struct InitArgs {
    ...
    /// Cache directory (default: .plasma/cache)
    #[arg(long)]
...
impl RunArgs {
    ...
    pub fn parse_runtime_and_script(&self) -> (Option<String>, String) {
        match self.positional_args.len() {
            ...
            1 => {
                // Just script: plasma run script.sh
                (None, self.positional_args[0].clone())
            }
            _ => {
                // Runtime + script: plasma run bash script.sh
                (
