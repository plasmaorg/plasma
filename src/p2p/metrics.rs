...
impl P2PMetrics {
    ...
    pub fn export_prometheus(&self) -> String {
        ...
        format!(
            r#"# HELP plasma_p2p_requests_total Total number of P2P cache requests
# TYPE plasma_p2p_requests_total counter
plasma_p2p_requests_total {}

# HELP plasma_p2p_hits_total Total number of P2P cache hits
# TYPE plasma_p2p_hits_total counter
plasma_p2p_hits_total {}

# HELP plasma_p2p_misses_total Total number of P2P cache misses
# TYPE plasma_p2p_misses_total counter
plasma_p2p_misses_total {}

# HELP plasma_p2p_hit_rate P2P cache hit rate (0.0 to 1.0)
# TYPE plasma_p2p_hit_rate gauge
plasma_p2p_hit_rate {:.4}

# HELP plasma_p2p_latency_ms Average P2P latency in milliseconds
# TYPE plasma_p2p_latency_ms gauge
plasma_p2p_latency_ms {:.2}

# HELP plasma_p2p_bytes_downloaded_total Total bytes downloaded from peers
# TYPE plasma_p2p_bytes_downloaded_total counter
plasma_p2p_bytes_downloaded_total {}

# HELP plasma_p2p_bytes_uploaded_total Total bytes uploaded to peers
# TYPE plasma_p2p_bytes_uploaded_total counter
plasma_p2p_bytes_uploaded_total {}

# HELP plasma_p2p_consent_requests_total Total consent requests
# TYPE plasma_p2p_consent_requests_total counter
plasma_p2p_consent_requests_total {}

# HELP plasma_p2p_consent_approvals_total Total consent approvals
# TYPE plasma_p2p_consent_approvals_total counter
plasma_p2p_consent_approvals_total {}

# HELP plasma_p2p_consent_denials_total Total consent denials
# TYPE plasma_p2p_consent_denials_total counter
plasma_p2p_consent_denials_total {}
"#,
            self.requests_total(),
            self.hits_total(),
            self.misses_total(),
